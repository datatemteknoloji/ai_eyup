    ...
    try:
        ...
        with engine.begin() as _conn:
            ...
            for _col_sql in [
                ...
                "ALTER TABLE servers ADD COLUMN IF NOT EXISTS vm_host_name VARCHAR(255)",
                "ALTER TABLE servers ADD COLUMN IF NOT EXISTS vm_host_ref VARCHAR(64)",
                "ALTER TABLE servers ADD COLUMN IF NOT EXISTS vm_guest_os_full VARCHAR(255)",
                "ALTER TABLE servers ADD COLUMN IF NOT EXISTS vm_disks JSONB",
                "ALTER TABLE servers ADD COLUMN IF NOT EXISTS vm_cpu_usage_mhz INTEGER",
                "ALTER TABLE servers ADD COLUMN IF NOT EXISTS vm_mem_active_mb INTEGER",
                "ALTER TABLE servers ADD COLUMN IF NOT EXISTS vm_stats_as_of TIMESTAMPTZ",
