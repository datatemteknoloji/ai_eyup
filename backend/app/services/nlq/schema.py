...
FIELD_SOURCE: Dict[str, str] = {
    ...
    "swap_usage_percent": "inventory",
    "cpu_iowait_percent": "inventory",
    "disk_io_utilization_percent": "inventory",
    "network_rx_bytes_per_sec": "inventory",
    "network_tx_bytes_per_sec": "inventory",
