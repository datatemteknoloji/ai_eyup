...
SYSTEM_PROMPT = (
    ...
    "get_processes, get_service_status, get_service_logs, get_network_status, "
    "get_package_status, get_security_events, execute_approved_command, run_diagnostic, "
    "read_service_logs, restart_service, update_packages, list_free_disks, lvm_info, "
    "manage_lvm araçlarını kullan. Spesifik bir konu (disk, servis, ağ, güvenlik, süreç vb.) "
    "sorulduğunda önce ilgili get_* aracını dene; run_diagnostic'i sadece bunların "
    "karşılamadığı özel/tek seferlik komutlar için kullan.\n"
