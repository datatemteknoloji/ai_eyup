      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-2">
        ...
        >
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div>
              <label className="mb-1 block text-xs text-[var(--color-muted-foreground)]">Type</label>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div>
              <label className="mb-1 block text-xs text-[var(--color-muted-foreground)]">Item</label>
            ...
            <div>
              <label className="mb-1 block text-xs text-[var(--color-muted-foreground)]">Değer</label>
              <Input
                className="font-mono"
