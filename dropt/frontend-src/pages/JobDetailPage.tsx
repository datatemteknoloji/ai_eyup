...
import { applyJob, downloadJobArtifact, getJob, JobPublic, previewJob } from "@/api";
...
export function JobDetailPage() {
  ...
  return (
    <div className="px-6 py-6">
      <div className="mb-4">
        <Link to="/app/jobs" className="text-xs text-[var(--color-muted-foreground)] hover:underline">
          {t("back_jobs")}
        </Link>
