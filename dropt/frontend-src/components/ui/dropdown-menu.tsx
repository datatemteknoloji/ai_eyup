...
>(({ className, sideOffset = 4, collisionPadding = 8, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 max-h-[min(85vh,var(--radix-dropdown-menu-content-available-height,85vh))] min-w-[12rem] overflow-y-auto overscroll-contain rounded-xl border border-[var(--color-border)] bg-[var(--color-popover)] p-1.5 text-[var(--color-popover-foreground)] shadow-xl",
        className,
      )}
      {...props}
    />
